class Agent:
    ...
    # e.g. self.mission_size[8][3] is the number to be sent on the 3rd mission in a game of 8  # noqa: E501
    mission_sizes = {
        5: [2, 3, 2, 3, 3],
        6: [2, 3, 4, 3, 4],
        7: [2, 3, 3, 4, 4],
    ...
    def vote_outcome(self, mission, proposer, votes):
        ...
        The agents on the mission are distinct and indexed between 0 and number_of_players.
        proposer is an int between 0 and number_of_players and is the index of the player who proposed the mission.
        votes is a dictionary mapping player indexes to Booleans (True if they voted for the mission, Fallinse otherwise).
